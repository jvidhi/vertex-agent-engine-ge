...
def return_instructions_bigquery() -> str:
    ...
    instruction_prompt_bqml_v1 = f"""
      ...
      2. You should also validate the SQL you have created for syntax and function errors (Use run_bigquery_validation tool ).
      3. Use the BuiltInCodeExecutionTool to evaluate the SQL code's logic if there's any complexity. If there are any errors, you should go back and address the error in the SQL.
